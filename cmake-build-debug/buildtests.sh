...
then
  C:/PROGRA~1/JetBrains/CLion 2024.3.5/bin/ninja/win/x64/ninja.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/PROGRA~1/JetBrains/CLion 2024.3.5/bin/ninja/win/x64/ninja.exe $targets_to_make 
fi
exit $?
